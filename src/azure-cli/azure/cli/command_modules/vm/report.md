...
|az vmss-vm-run-command|VirtualMachineScaleSetVMRunCommands|[commands](#CommandsInVirtualMachineScaleSetVMRunCommands)|
...
### <a name="CommandsInVirtualMachineScaleSetVMRunCommands">Commands in `az vmss-vm-run-command` group</a>
|CLI Command|Operation Swagger name|Parameters|Examples|
|---------|------------|--------|-----------|
|[az vmss-vm-run-command list](#VirtualMachineScaleSetVMRunCommandsList)|List|[Parameters](#ParametersVirtualMachineScaleSetVMRunCommandsList)|[Example](#ExamplesVirtualMachineScaleSetVMRunCommandsList)|
...
### group `az vmss-vm-run-command`
#### <a name="VirtualMachineScaleSetVMRunCommandsList">Command `az vmss-vm-run-command list`</a>

##### <a name="ExamplesVirtualMachineScaleSetVMRunCommandsList">Example</a>
```
az vmss-vm-run-command list --instance-id "0" --resource-group "myResourceGroup" --vm-scale-set-name "myvmScaleSet"
```
